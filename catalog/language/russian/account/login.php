...
$_['text_register_account']        = 'Преимущества регистрации:<br />– Не придется каждый раз вводить данные для заказа (ФИО, адрес, телефон итд.)<br />– У Вас будет личный кабинет<br />– Возможность отслеживать свои заказы<br />– Копить скидки как наш постоянный покупатель';
