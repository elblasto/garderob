 ...
 <div class="wrapFoot">
  ...
  <div class="column shown-phone">
    ...
    <ul>
      ...
      <li><a href="/make_order">Как заказать</a></li>
      <li><a href="/size_chart">Размеры</a></li>
      <li><a href="/help_to_find">Не нашли нужное?</a></li>
  ...
  <div class="column shown-phone">
    ...
    <ul>
      <li><a href="/discount">Cкидки</a></li>
      <li><a href="/promo">Акции</a></li>  
      <li><a href="<?php echo $manufacturer; ?>"><?php echo $text_manufacturer; ?></a></li>
      <li><a href="/wholesale">Оптовое сотрудничество</a></li>      
...
<?php if(isset($store_settings)){ ?>  
  ...
  <?php if(isset($store_settings['email']) && $store_settings['email']!=''){?>
	<div class='icon_mail' title='Email'><a href="mailto:<?php echo $store_settings['email'];?>"><?php echo $store_settings['email'];?></a></div>	
  <?php } ?>
  <?php if(isset($store_settings['location']) && $store_settings['location']!=''){?>
	<div class='icon_vk' title='Vkontakte'><a href="http://vk.com/garderobe" target="_blank"><?php echo $store_settings['location'];?></a></div>	
  <?php } ?>
<?php } ?>  
  	<div class='clear'></div>
  	<div class='h10'></div>
...
<?php if(isset($store_settings)){ ?>   
  ...
  <?php } ?>	  	
<?php } ?>  
	  	<div id="powered"><a href="http://garderobeshop.ru" target="_blank">Garderobe Shop</a> © 2009-<?php echo date("Y");?> &nbsp;</div>
  </div>
</div>
</div><!-- wrapFoot -->
