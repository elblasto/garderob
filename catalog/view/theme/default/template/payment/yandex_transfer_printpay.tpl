<html>
<head>
<title>Оплата Яндекс.Деньги - <?php echo $inn ?></title>
...
<font size="2"><b>Итого к оплате:</b> <?php echo $amount." руб. (сумма заказа) + ".round($amount*0.00502333333,2)." руб. (комиссия Яндекс) = ".round($amount+$amount*0.00502333333,2)." руб." ?>
</br></br>
...
<noscript><div><img src="//mc.yandex.ru/watch/13218340" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</body>
<html>